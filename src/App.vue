    ...
    <v-container>
      <v-row>
        <v-container>
          ...
          <h1 class="text-center white--text mb-8">Created by
            <a href="https://github.com/pedropiedadee" class="red--text">Pedro Piedade</a>
          </h1>
        </v-container>
      </v-row>
    ...
    <v-card v-if="selected_pokemon" class="px-2">
      <v-container>
        <v-row class="d-flex align-center">
          <v-col cols="4">
            <img :src="`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${selected_pokemon.id}.png`" :alt="selected_pokemon.name" width="80%">
          </v-col>
          <v-col cols="8">
